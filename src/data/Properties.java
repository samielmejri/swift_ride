...
public class Properties {
    ...
    public List<Rout> routing(double fromLat, double fromLon, double toLat, double toLon) {
        ...
        for (Instruction instruction : il) {
            ...
            list.add(new Rout(instruction.getDistance(), instruction.getTurnDescription(tr), instruction.getPoints()));
        }
        return list;
    }
}
